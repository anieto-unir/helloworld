...
class TestApiUnit(unittest.TestCase):
    ...
    def test_hello_endpoint(self):
        """Test del endpoint hello - cubre función hello()"""
        result = hello()
    ...
    def test_add_endpoint_success(self, mock_calc_add, mock_convert):
        """Test del endpoint add con parámetros válidos - cubre branch try exitoso"""
    ...
    def test_add_endpoint_type_error(self, mock_convert):
        """Test del endpoint add con error de tipo - cubre branch except"""
    ...
    def test_substract_endpoint_success(self, mock_calc_sub, mock_convert):
        """Test del endpoint substract con parámetros válidos - cubre branch try exitoso"""
    ...
    def test_substract_endpoint_type_error(self, mock_convert):
        """Test del endpoint substract con error de tipo - cubre branch except"""
